...
template <typename T> void _cs149_vset(__cs149_vec<T> &vecResult, T value, __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
...
template void _cs149_vmove<float>(__cs149_vec_float &dest, __cs149_vec_float &src,
                                  __cs149_mask &mask);
...
template <typename T> void _cs149_vload(__cs149_vec<T> &dest, T *src, __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
...
template <typename T> void _cs149_vstore(T *dest, __cs149_vec<T> &src, __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
...
template <typename T>
void _cs149_vadd(__cs149_vec<T> &vecResult, __cs149_vec<T> &veca, __cs149_vec<T> &vecb,
                 __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
...
template void _cs149_vadd<float>(__cs149_vec_float &vecResult, __cs149_vec_float &veca,
                                 __cs149_vec_float &vecb, __cs149_mask &mask);
template void _cs149_vadd<int>(__cs149_vec_int &vecResult, __cs149_vec_int &veca,
...
template <typename T>
void _cs149_vsub(__cs149_vec<T> &vecResult, __cs149_vec<T> &veca, __cs149_vec<T> &vecb,
                 __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
    vecResult.value[i] = mask.value[i] ? (veca.value[i] - vecb.value[i]) : vecResult.value[i];
  }
...
template void _cs149_vsub<float>(__cs149_vec_float &vecResult, __cs149_vec_float &veca,
                                 __cs149_vec_float &vecb, __cs149_mask &mask);
template void _cs149_vsub<int>(__cs149_vec_int &vecResult, __cs149_vec_int &veca,
                               __cs149_vec_int &vecb, __cs149_mask &mask);
...
template <typename T>
void _cs149_vmult(__cs149_vec<T> &vecResult, __cs149_vec<T> &veca, __cs149_vec<T> &vecb,
                  __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
    vecResult.value[i] = mask.value[i] ? (veca.value[i] * vecb.value[i]) : vecResult.value[i];
  }
...
template void _cs149_vmult<float>(__cs149_vec_float &vecResult, __cs149_vec_float &veca,
                                  __cs149_vec_float &vecb, __cs149_mask &mask);
template void _cs149_vmult<int>(__cs149_vec_int &vecResult, __cs149_vec_int &veca,
                                __cs149_vec_int &vecb, __cs149_mask &mask);
...
template <typename T>
void _cs149_vdiv(__cs149_vec<T> &vecResult, __cs149_vec<T> &veca, __cs149_vec<T> &vecb,
                 __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
    vecResult.value[i] = mask.value[i] ? (veca.value[i] / vecb.value[i]) : vecResult.value[i];
  }
...
template void _cs149_vdiv<float>(__cs149_vec_float &vecResult, __cs149_vec_float &veca,
                                 __cs149_vec_float &vecb, __cs149_mask &mask);
template void _cs149_vdiv<int>(__cs149_vec_int &vecResult, __cs149_vec_int &veca,
                               __cs149_vec_int &vecb, __cs149_mask &mask);
...
template void _cs149_vabs<float>(__cs149_vec_float &vecResult, __cs149_vec_float &veca,
                                 __cs149_mask &mask);
template void _cs149_vabs<int>(__cs149_vec_int &vecResult, __cs149_vec_int &veca,
                               __cs149_mask &mask);
...
template <typename T>
void _cs149_vgt(__cs149_mask &maskResult, __cs149_vec<T> &veca, __cs149_vec<T> &vecb,
                __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
...
template void _cs149_vgt<float>(__cs149_mask &maskResult, __cs149_vec_float &veca,
                                __cs149_vec_float &vecb, __cs149_mask &mask);
template void _cs149_vgt<int>(__cs149_mask &maskResult, __cs149_vec_int &veca,
                              __cs149_vec_int &vecb, __cs149_mask &mask);

void _cs149_vgt_float(__cs149_mask &maskResult, __cs149_vec_float &veca, __cs149_vec_float &vecb,
                      __cs149_mask &mask) {
  _cs149_vgt<float>(maskResult, veca, vecb, mask);
}
void _cs149_vgt_int(__cs149_mask &maskResult, __cs149_vec_int &veca, __cs149_vec_int &vecb,
                    __cs149_mask &mask) {
  _cs149_vgt<int>(maskResult, veca, vecb, mask);
}

template <typename T>
void _cs149_vlt(__cs149_mask &maskResult, __cs149_vec<T> &veca, __cs149_vec<T> &vecb,
                __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
    maskResult.value[i] = mask.value[i] ? (veca.value[i] < vecb.value[i]) : maskResult.value[i];
  }
...
template void _cs149_vlt<float>(__cs149_mask &maskResult, __cs149_vec_float &veca,
                                __cs149_vec_float &vecb, __cs149_mask &mask);
template void _cs149_vlt<int>(__cs149_mask &maskResult, __cs149_vec_int &veca,
                              __cs149_vec_int &vecb, __cs149_mask &mask);

void _cs149_vlt_float(__cs149_mask &maskResult, __cs149_vec_float &veca, __cs149_vec_float &vecb,
                      __cs149_mask &mask) {
  _cs149_vlt<float>(maskResult, veca, vecb, mask);
}
void _cs149_vlt_int(__cs149_mask &maskResult, __cs149_vec_int &veca, __cs149_vec_int &vecb,
                    __cs149_mask &mask) {
  _cs149_vlt<int>(maskResult, veca, vecb, mask);
}

template <typename T>
void _cs149_veq(__cs149_mask &maskResult, __cs149_vec<T> &veca, __cs149_vec<T> &vecb,
                __cs149_mask &mask) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
    maskResult.value[i] = mask.value[i] ? (veca.value[i] == vecb.value[i]) : maskResult.value[i];
  }
...
template void _cs149_veq<float>(__cs149_mask &maskResult, __cs149_vec_float &veca,
                                __cs149_vec_float &vecb, __cs149_mask &mask);
template void _cs149_veq<int>(__cs149_mask &maskResult, __cs149_vec_int &veca,
                              __cs149_vec_int &vecb, __cs149_mask &mask);

void _cs149_veq_float(__cs149_mask &maskResult, __cs149_vec_float &veca, __cs149_vec_float &vecb,
                      __cs149_mask &mask) {
  _cs149_veq<float>(maskResult, veca, vecb, mask);
}
void _cs149_veq_int(__cs149_mask &maskResult, __cs149_vec_int &veca, __cs149_vec_int &vecb,
                    __cs149_mask &mask) {
  _cs149_veq<int>(maskResult, veca, vecb, mask);
}

template <typename T> void _cs149_hadd(__cs149_vec<T> &vecResult, __cs149_vec<T> &vec) {
...
template <typename T> void _cs149_interleave(__cs149_vec<T> &vecResult, __cs149_vec<T> &vec) {
  for (int i = 0; i < VECTOR_WIDTH; i++) {
...
void addUserLog(const char *logStr) { CS149Logger.addLog(logStr, _cs149_init_ones(), 0); }
